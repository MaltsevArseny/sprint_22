...
public class OrderService {
    ...
    public OrderDto createNewOrder(CreateNewOrderRequest request) {
        ...
        DeliveryDto delivery = deliveryClient.planDelivery(orderMapper.toDto(order));
        order.setDeliveryId(delivery.getDeliveryId());

        java.math.BigDecimal productsPrice = paymentClient.productCost(orderMapper.toDto(order));
    ...
    public OrderDto payment(UUID orderId) {
        ...
        java.math.BigDecimal totalPrice = paymentClient.getTotalCost(orderMapper.toDto(order));
    ...
    public OrderDto calculateDeliveryCost(UUID orderId) {
        Order order = findOrder(orderId);
        java.math.BigDecimal deliveryPrice = deliveryClient.deliveryCost(orderMapper.toDto(order));
    ...
    public OrderDto calculateTotalCost(UUID orderId) {
        Order order = findOrder(orderId);
        java.math.BigDecimal total = paymentClient.getTotalCost(orderMapper.toDto(order));
